...
function selectSalon(element) {
    let selectedSalon = element.textContent || element.value;
...
function enviarVale() {
    ...
    fetch('/estudiante/vale/enviado', {
        method: 'POST',
        body: JSON.stringify({revision: valeId, materia: materia, grupo: grupo, vale: vale, profesor: profesor, alumnos: alumnos, laboratorio: laboratorio, items: materialList }),
...
window.addEventListener("DOMContentLoaded", () => {
    ...
    selectedSalon = salonInput.value;
